...
# Other
alias wtr='curl wttr.in/limerick'
alias hp='ls --hide=*.py'
...
alias zln='zmv -L'
alias zcp='zmv -C'
# alias sz='source /media/ubuntu/3520-FD13/zim/Computer/1Linux_Live_USB/dot_files/.zshrc'
alias sz='source ~/dot_files/zshrc'
# alias sv='source ~/dot_files/vimrc' within vim :source ~/dot_files/vimrc
